"""Inspect native FLUX.2 traces and isolate one complete forward by launch ownership."""
import bisect
import collections
import gzip
import json
...
models=sorted((e for e in events if e.get('name')=='nn.Module: Flux2Transformer2DModel_0'),key=lambda e:e['ts'])
