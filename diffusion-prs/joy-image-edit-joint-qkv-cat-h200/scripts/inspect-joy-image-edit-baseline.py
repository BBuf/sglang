...
done=root/'joy-image-edit-baseline-profile.exit'
...
log=re.sub(r'\x1b\[[0-9;]*m','',(root/'joy-image-edit-baseline-a1.log').read_text())
clients=re.findall(r'Pixel data generated successfully in ([\d.]+) seconds',log)
assert len(clients)==1
from PIL import Image
image=Image.open(next((art/'baseline-a1').glob('*.png')))
