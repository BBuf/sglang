"""Inspect native Joy image edit traces and isolate one complete forward by launch ownership."""
import bisect
import collections
import gzip
import json
...
models=sorted((e for e in events if e.get('name')=='nn.Module: JoyImageEditTransformer3DModel_0'),key=lambda e:e['ts'])
